...
const configList: Record<string, Config> = {
  development: {
    products: [
      ...
      {
        id: "PLACEHOLDER_HOBBY_YEARLY_ID",
        name: "hobby-yearly",
        label: "Hobby",
        family: "hobby",
        billingCycle: "yearly",
        price: "49",
        bandwidth: 25_000_000_000,
        link: "PLACEHOLDER_HOBBY_YEARLY_LINK",
        type: "standard",
        concurrencyLimit: 3,
        description: "Perfect for hobby projects",
        benefits: STANDARD_BENEFITS.hobby,
      ...
      {
        id: "PLACEHOLDER_GROWTH_YEARLY_ID",
        name: "growth-yearly",
        label: "Growth",
        family: "growth",
        billingCycle: "yearly",
        price: "89",
        bandwidth: 100_000_000_000,
        link: "PLACEHOLDER_GROWTH_YEARLY_LINK",
        type: "standard",
        concurrencyLimit: 15,
        description: "Built for growing websites",
        benefits: STANDARD_BENEFITS.growth,
      ...
      {
        id: "PLACEHOLDER_SCALE_YEARLY_ID",
        name: "scale-yearly",
        label: "Scale",
        family: "scale",
        billingCycle: "yearly",
        price: "189",
        bandwidth: 500_000_000_000,
        link: "PLACEHOLDER_SCALE_YEARLY_LINK",
        type: "standard",
        concurrencyLimit: 100,
        description: "For websites ready to scale",
        benefits: STANDARD_BENEFITS.scale,
